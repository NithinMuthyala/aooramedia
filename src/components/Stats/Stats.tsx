  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        {/* Blue glow */}
        <div className="absolute -left-40 top-0 h-[500px] w-[500px] rounded-full bg-[#38BDF8]/10 blur-[150px]" />

        {/* Purple glow */}
        <div className="absolute -bottom-20 right-0 h-[450px] w-[450px] rounded-full bg-[#7C3AED]/12 blur-[140px]" />
      ...
      <div className="relative overflow-hidden border-b border-white/5 py-4">
        ...
        >
          {marqueeItems.map((item, i) => (
            ...
            >
              <span className="h-1 w-1 rounded-full bg-[#38BDF8]/50" />
              {item}
            </span>
          ))}
        </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 lg:px-8 md:py-32">
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat, index) => (
            <div
              key={stat.label}
              className="stat-card group relative overflow-hidden rounded-3xl border border-white/8 bg-white/4 p-7 backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:border-[#38BDF8]/25 hover:bg-white/8 hover:shadow-2xl hover:shadow-[#38BDF8]/10"
            >
              {/* Hover glow overlay */}
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#38BDF8]/0 to-[#7C3AED]/0 opacity-0 transition-opacity duration-500 group-hover:from-[#38BDF8]/8 group-hover:to-[#7C3AED]/5 group-hover:opacity-100" />

              {/* Top right icon */}
              <div className="absolute right-6 top-6 text-2xl text-white/10 transition-all duration-500 group-hover:scale-110 group-hover:text-[#38BDF8]/30">
                {stat.icon}
              </div>
              ...
              {/* Divider */}
              <div className="mt-6 h-px w-full bg-gradient-to-r from-[#38BDF8]/20 via-white/5 to-transparent" />
              ...
              {/* Animated accent bar */}
              <div className="mt-6 h-[3px] w-8 rounded-full bg-gradient-to-r from-[#38BDF8] to-[#7C3AED] transition-all duration-500 group-hover:w-16" />
            </div>
          ))}
        </div>
      ...
      ========================================= */}
      <div className="relative overflow-hidden border-t border-white/5 py-4">
        <div
          className="marquee-inner flex gap-10 whitespace-nowrap"
          style={{ width: "200%" }}
        >
